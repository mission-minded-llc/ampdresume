...
export const mutationDefs = gql`
  type Mutation {
    ...
    updateUser(userId: ID!, webThemeName: String, pdfThemeName: String): User!
    ...
    # Featured Project skill mutations.
    ...
    deleteSkillForFeaturedProject(userId: ID!, id: ID!): SkillForFeaturedProject!
    ...
    deleteFeaturedProject(userId: ID!, id: ID!): FeaturedProject!
  }

  input FeaturedProjectLinkInput {
    label: String!
    url: String!
  }
