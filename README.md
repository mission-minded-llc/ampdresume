...
[![codecov](https://codecov.io/gh/mission-minded-llc/ampdresume/branch/main/graph/badge.svg?token=MHMQ1EHZO1)](https://codecov.io/gh/mission-minded-llc/ampdresume)
...
7. Verify the domain in Google Search Console, enable `enable_domain_mapping`, and add the DNS
   records Cloud Run reports. On Cloudflare Free, grey-cloud those records (Origin Rules are a paid
   feature).
